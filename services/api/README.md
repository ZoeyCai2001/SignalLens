...
curl "http://127.0.0.1:8000/api/search?q=agent&module=research&limit=10"
...
curl -X POST "http://127.0.0.1:8000/api/digest/daily/snapshots?date=2026-06-25&limit_per_section=3"
